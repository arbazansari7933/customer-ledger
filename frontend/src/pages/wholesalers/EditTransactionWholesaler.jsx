...
const EditTransactionWholesaler = () => {
    const navigate = useNavigate();
    const [message, setMessage] = useState("");
    const { transactionId } = useParams();
    const location = useLocation()
    const { type, wholesalerId } = location.state || {}
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const res = await api.put(`/wholesalers/${wholesalerId}/transactions/${transactionId}`, data);
    ...
    useEffect(() => {
        ...
        load();
    }, [wholesalerId, transactionId, setValue]);
...
export default EditTransactionWholesaler
